...
<form class="form-inline" action="{{route('student.store')}}" method="POST">
    @csrf
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
            <label class="sr-only" for="email">Student Name</label>
            <input type="student_name" class="form-control" name="student_name" value="{{old('student_name')}}">
            </div>
            @error('student_name')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="student_email" class="form-control" name="student_email" value="{{old('student_email')}}">
            </div>
            @error('student_email')
                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
            @enderror
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="student_phone_number" class="form-control" name="student_phone_number" value="{{old('student_phone_number')}}">
            </div>
        ...
        <div class="col-md-6">
            <div class="form-group m-2">
                ...
                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                    <input type="radio" class="btn-check" name="gender" id="btnradio1" autocomplete="off" value='1' {{ old('gender') == "1"? "checked" : '' }}>
                    <label class="btn btn-outline-primary" for="btnradio1">Male</label>
                    <input type="radio" class="btn-check" name="gender" id="btnradio2" value="2" {{ old('gender') == "2"? "checked" : '' }} autocomplete="off">
